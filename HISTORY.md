...
Ниже — **снимок** `git log --reverse` (с первого коммита по `bf61808`); при появлении новых ревизий пересоберите таблицу командой в подвале — иначе цифра «все коммиты» устаревает. Таблица выше сжимает смысл; дубликаты смотрите в SHA.
