...
_STACK_KEY_REGISTRY: dict[str, KeyMeta] = {
    ...
    # --- Network / service DNS / internal ports / container names (added in 5.2.0) ---
    "SLGPU_NETWORK_NAME": _e(
        "SLGPU_NETWORK_NAME",
        "network",
        "External Docker bridge network shared by web/monitoring/proxy/LLM slots.",
        "web_up",
        *S_LLM,
        *S_ALL_COMPOSE,
        "fix_perms",
    ...
    # Web container
    "WEB_DOCKER_IMAGE": _e("WEB_DOCKER_IMAGE", "images", "Docker image tag for slgpu-web.", "web_up"),
    "WEB_CONTAINER_NAME": _e("WEB_CONTAINER_NAME", "network", "Container name of slgpu-web.", "web_up"),
    "WEB_INTERNAL_PORT": _e("WEB_INTERNAL_PORT", "network", "uvicorn port inside the web container.", "web_up"),
    # Monitoring services (DNS in slgpu network + internal ports + container names)
    "PROMETHEUS_SERVICE_NAME": _e("PROMETHEUS_SERVICE_NAME", "network", "Prometheus DNS name in slgpu network.", *S_MON),
    "PROMETHEUS_INTERNAL_PORT": _e("PROMETHEUS_INTERNAL_PORT", "network", "Prometheus port inside the container.", *S_MON),
    "PROMETHEUS_CONTAINER_NAME": _e("PROMETHEUS_CONTAINER_NAME", "network", "Prometheus container_name.", *S_MON),
    "GRAFANA_SERVICE_NAME": _e("GRAFANA_SERVICE_NAME", "network", "Grafana DNS name in slgpu network.", *S_MON),
    "GRAFANA_INTERNAL_PORT": _e("GRAFANA_INTERNAL_PORT", "network", "Grafana port inside the container.", *S_MON),
    "GRAFANA_CONTAINER_NAME": _e("GRAFANA_CONTAINER_NAME", "network", "Grafana container_name.", *S_MON),
    "LOKI_SERVICE_NAME": _e("LOKI_SERVICE_NAME", "network", "Loki DNS name in slgpu network.", *S_MON),
    "LOKI_INTERNAL_PORT": _e("LOKI_INTERNAL_PORT", "network", "Loki port inside the container.", *S_MON),
    "LOKI_CONTAINER_NAME": _e("LOKI_CONTAINER_NAME", "network", "Loki container_name.", *S_MON),
    "PROMTAIL_SERVICE_NAME": _e("PROMTAIL_SERVICE_NAME", "network", "Promtail DNS name in slgpu network.", *S_MON),
    "PROMTAIL_CONTAINER_NAME": _e("PROMTAIL_CONTAINER_NAME", "network", "Promtail container_name.", *S_MON),
    "DCGM_EXPORTER_SERVICE_NAME": _e("DCGM_EXPORTER_SERVICE_NAME", "network", "dcgm-exporter DNS name.", *S_MON),
    "DCGM_EXPORTER_INTERNAL_PORT": _e("DCGM_EXPORTER_INTERNAL_PORT", "network", "dcgm-exporter port inside container.", *S_MON),
    "DCGM_EXPORTER_CONTAINER_NAME": _e("DCGM_EXPORTER_CONTAINER_NAME", "network", "dcgm-exporter container_name.", *S_MON),
    "NODE_EXPORTER_SERVICE_NAME": _e("NODE_EXPORTER_SERVICE_NAME", "network", "node-exporter DNS name.", *S_MON),
    "NODE_EXPORTER_INTERNAL_PORT": _e("NODE_EXPORTER_INTERNAL_PORT", "network", "node-exporter port inside container.", *S_MON),
    "NODE_EXPORTER_CONTAINER_NAME": _e("NODE_EXPORTER_CONTAINER_NAME", "network", "node-exporter container_name.", *S_MON),
    # Proxy services
    "LANGFUSE_WEB_SERVICE_NAME": _e("LANGFUSE_WEB_SERVICE_NAME", "network", "Langfuse web DNS name.", *S_MON),
    "LANGFUSE_WEB_INTERNAL_PORT": _e("LANGFUSE_WEB_INTERNAL_PORT", "network", "Langfuse web port inside container.", *S_MON),
    "LANGFUSE_WEB_CONTAINER_NAME": _e("LANGFUSE_WEB_CONTAINER_NAME", "network", "Langfuse web container_name.", *S_MON),
    "LANGFUSE_WORKER_SERVICE_NAME": _e("LANGFUSE_WORKER_SERVICE_NAME", "network", "Langfuse worker DNS name.", *S_MON),
    "LANGFUSE_WORKER_INTERNAL_PORT": _e("LANGFUSE_WORKER_INTERNAL_PORT", "network", "Langfuse worker port inside container.", *S_MON),
    "LANGFUSE_WORKER_CONTAINER_NAME": _e("LANGFUSE_WORKER_CONTAINER_NAME", "network", "Langfuse worker container_name.", *S_MON),
    "POSTGRES_SERVICE_NAME": _e("POSTGRES_SERVICE_NAME", "network", "Postgres DNS name in slgpu network.", *S_MON),
    "POSTGRES_INTERNAL_PORT": _e("POSTGRES_INTERNAL_PORT", "network", "Postgres port inside the container.", *S_MON),
    "POSTGRES_CONTAINER_NAME": _e("POSTGRES_CONTAINER_NAME", "network", "Postgres container_name.", *S_MON),
    "REDIS_SERVICE_NAME": _e("REDIS_SERVICE_NAME", "network", "Redis DNS name in slgpu network.", *S_MON),
    "REDIS_INTERNAL_PORT": _e("REDIS_INTERNAL_PORT", "network", "Redis port inside the container.", *S_MON),
    "REDIS_CONTAINER_NAME": _e("REDIS_CONTAINER_NAME", "network", "Redis container_name.", *S_MON),
    "CLICKHOUSE_SERVICE_NAME": _e("CLICKHOUSE_SERVICE_NAME", "network", "ClickHouse DNS name in slgpu network.", *S_MON),
    "CLICKHOUSE_HTTP_INTERNAL_PORT": _e("CLICKHOUSE_HTTP_INTERNAL_PORT", "network", "ClickHouse HTTP port inside the container.", *S_MON),
    "CLICKHOUSE_TCP_INTERNAL_PORT": _e("CLICKHOUSE_TCP_INTERNAL_PORT", "network", "ClickHouse TCP/native port inside container.", *S_MON),
    "CLICKHOUSE_CONTAINER_NAME": _e("CLICKHOUSE_CONTAINER_NAME", "network", "ClickHouse container_name.", *S_MON),
    "MINIO_SERVICE_NAME": _e("MINIO_SERVICE_NAME", "network", "MinIO DNS name in slgpu network.", *S_MON),
    "MINIO_API_INTERNAL_PORT": _e("MINIO_API_INTERNAL_PORT", "network", "MinIO S3 API port inside container.", *S_MON),
    "MINIO_CONSOLE_INTERNAL_PORT": _e("MINIO_CONSOLE_INTERNAL_PORT", "network", "MinIO console port inside container.", *S_MON),
    "MINIO_CONTAINER_NAME": _e("MINIO_CONTAINER_NAME", "network", "MinIO container_name.", *S_MON),
    "MINIO_BUCKET_INIT_CONTAINER_NAME": _e("MINIO_BUCKET_INIT_CONTAINER_NAME", "network", "MinIO bucket-init bootstrap container_name.", *S_MON),
    "LITELLM_SERVICE_NAME": _e("LITELLM_SERVICE_NAME", "network", "LiteLLM DNS name in slgpu network.", *S_MON),
    "LITELLM_CONTAINER_NAME": _e("LITELLM_CONTAINER_NAME", "network", "LiteLLM container_name.", *S_MON),
    "LITELLM_PG_INIT_CONTAINER_NAME": _e("LITELLM_PG_INIT_CONTAINER_NAME", "network", "LiteLLM Postgres init bootstrap container_name.", *S_MON),
}
