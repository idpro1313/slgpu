...
| **DeepSeek V4 (Pro/Flash, vLLM):** `DeepseekV4 only supports fp8 kv-cache… got auto` | `KV_CACHE_DTYPE=fp8_e4m3` (в [`deepseek-v4-pro.env`](configs/models/deepseek-v4-pro.env) / [`deepseek-v4-flash.env`](configs/models/deepseek-v4-flash.env)), не `auto` |
